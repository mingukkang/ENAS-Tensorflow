...
Unlike the author's code, This code can work in a windows 10 enviroment and you can use png images to train.
...
<br/>![사진3](https://github.com/MINGUKKANG/ENAS-Tensorflow/blob/master/images/Reduction_cell.png)
